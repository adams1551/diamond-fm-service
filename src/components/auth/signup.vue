                  ...
                  <form @submit="signin">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
                        ...
                        <!-- <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input" id="text-field-hero-input" v-model="password">
                            <div class="mdc-line-ripple"></div>
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input" type="password" id="text-field-hero-input" v-model="password">
                            <div class="mdc-line-ripple"></div>
                            <label for="text-field-hero-input" class="mdc-floating-label">Password</label>
                          </div>
                        </div>
    ...
    methods:{
      signIn($event){
        ...
        AuthService.signupAgent({
          ...
          this.ussername = ''
          this.password = ''
          AuthService.setActiveToken(res['accessToken']['data'])
